...
class CarTableViewController: UITableViewController {
    ...
    public func setup() {
        cars = [
            Car(carName: "Nissan Teana", carPrice: "1100000", carImage: "Nissan Teana", carYear: "2015", salerPhone: "88003553535", description: "Куплен в 2013г. Крашенных элементов нет, бесключевой доступ, запуск с кнопки, цветной дисплей, Сигнализация с автозапуском, 2 комплекта резины. Я 2-й хозяин, автомобиль беспроблемный очень надежный. Поменяны все жидкости, фильтра, колодки. Автосалоны не звоните.", mileage: "18900", salerName:"NIKOLAI" ),
